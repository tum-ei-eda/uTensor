 ...
 * Title:        riscv_fully_connected_int16_opt.c
 * Description:  int16 opt fully-connected layer function
 *
...
void
riscv_fully_connected_int16_opt(const int16_t * pV,
                            const int16_t * pM,
                            ...
                            int16_t * vec_buffer)
{
    ...
    while (rowCnt)
    {
        ...
        *pO++ = (int16_t) __SSAT((ip_out >> out_shift), 16);
